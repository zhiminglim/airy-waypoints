...
// SIDs
app.get("/api/v1/sids/busy-waypoints", (req, res) => {
...
// STARs
app.get("/api/v1/stars/busy-waypoints", (req, res) => {
  const finalResultForJSON = [];
  ...
  async function doRequests() {
    ...
    // Part 2
    for (let airportName of airportMap.keys()) {
      options.uri = "https://open-atms.airlab.aero/api/v1/airac/stars/airport/" + airportName;
      response = await rp(options);
